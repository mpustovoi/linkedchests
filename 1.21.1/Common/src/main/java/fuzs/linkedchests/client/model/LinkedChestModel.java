...
public class LinkedChestModel extends Model {
    ...
    public final ModelPart leftButton, middleButton, rightButton;
    ...
    public LinkedChestModel(BlockEntityRendererProvider.Context context) {
        ...
        this.leftButton = modelPart.getChild("color1");
        this.middleButton = modelPart.getChild("color2");
        this.rightButton = modelPart.getChild("color3");
    }
    ...
    public void setLidPitch(float pitch) {
        pitch = 1.0F - pitch;
        this.leftButton.xRot = this.middleButton.xRot = this.rightButton.xRot = this.latch.xRot = this.lid.xRot = -(
